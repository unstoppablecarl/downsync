import fs from 'fs'
import { stripQuickReferenceContentTags } from '../../../markdown/support/markdown-helpers.js'

let path = 'src/markdown/downsync-rules.md'

export const markdown = await fs.promises.readFile(path, 'utf-8').then(markdown => stripQuickReferenceContentTags(markdown))
